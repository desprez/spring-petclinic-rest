...
public class SpecialtyRestControllerTests {
    ...
    public void initSpecialtys() {
        this.mockMvc = MockMvcBuilders.standaloneSetup(specialtyRestController).setControllerAdvice(new ExceptionControllerAdvice()).build();
    ...
    public void testGetSpecialtySuccess() throws Exception {
        ...
        this.mockMvc.perform(get("/api/specialties/1").accept(MediaType.APPLICATION_JSON_VALUE)).andExpect(status().isOk())
    ...
    public void testGetSpecialtyNotFound() throws Exception {
        ...
        this.mockMvc.perform(get("/api/specialties/-1").accept(MediaType.APPLICATION_JSON)).andExpect(status().isNotFound());
    }
    ...
    public void testGetAllSpecialtysNotFound() throws Exception {
        specialties.clear();
        given(this.clinicService.findAllSpecialties()).willReturn(specialties);
        this.mockMvc.perform(get("/api/specialties/").accept(MediaType.APPLICATION_JSON)).andExpect(status().isNotFound());
    }
    ...
    public void testCreateSpecialtySuccess() throws Exception {
        ...
        this.mockMvc.perform(
                post("/api/specialties/").content(newSpecialtyAsJSON).accept(MediaType.APPLICATION_JSON_VALUE).contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void testUpdateSpecialtySuccess() throws Exception {
        ...
        this.mockMvc.perform(get("/api/specialties/2").accept(MediaType.APPLICATION_JSON).contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk()).andExpect(content().contentType("application/json;charset=UTF-8")).andExpect(jsonPath("$.id").value(2))
    ...
    public void testUpdateSpecialtyError() throws Exception {
        ...
        String newSpecialtyAsJSON = mapper.writeValueAsString(newSpecialty);
        this.mockMvc.perform(
                put("/api/specialties/1").content(newSpecialtyAsJSON).accept(MediaType.APPLICATION_JSON_VALUE).contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isBadRequest());
    }
    ...
    public void testDeleteSpecialtySuccess() throws Exception {
        ...
        given(this.clinicService.findSpecialtyById(1)).willReturn(specialties.get(0));
        this.mockMvc.perform(
                delete("/api/specialties/1").content(newSpecialtyAsJSON).accept(MediaType.APPLICATION_JSON_VALUE).contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void testDeleteSpecialtyError() throws Exception {
        ...
        String newSpecialtyAsJSON = mapper.writeValueAsString(newSpecialty);
        given(this.clinicService.findSpecialtyById(-1)).willReturn(null);
        this.mockMvc.perform(delete("/api/specialties/-1").content(newSpecialtyAsJSON).accept(MediaType.APPLICATION_JSON_VALUE)
