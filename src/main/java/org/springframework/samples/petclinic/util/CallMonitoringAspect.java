...
/**
 * Simple aspect that monitors call count and call invocation time. It uses JMX annotations and therefore can be monitored using any JMX console such as the
 * jConsole
 * <p/>
