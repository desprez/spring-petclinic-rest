...
public class JdbcPetTypeRepositoryImpl implements PetTypeRepository {
    ...
    public JdbcPetTypeRepositoryImpl(DataSource dataSource) {
        ...
        this.insertPetType = new SimpleJdbcInsert(dataSource).withTableName("types").usingGeneratedKeyColumns("id");
    }
    ...
    public PetType findById(int id) {
        ...
        try {
            ...
            params.put("id", id);
            petType = this.namedParameterJdbcTemplate.queryForObject("SELECT id, name FROM types WHERE id= :id", params,
    ...
    public Collection<PetType> findAll() throws DataAccessException {
        Map<String, Object> params = new HashMap<>();
        return this.namedParameterJdbcTemplate.query("SELECT id, name FROM types", params, BeanPropertyRowMapper.newInstance(PetType.class));
    }
    ...
    public void delete(PetType petType) throws DataAccessException {
        ...
        pets = this.namedParameterJdbcTemplate.query("SELECT pets.id, name, birth_date, type_id, owner_id FROM pets WHERE type_id=:id", pettype_params,
        ...
        for (Pet pet : pets) {
            ...
            visits = this.namedParameterJdbcTemplate.query("SELECT id, pet_id, visit_date, description FROM visits WHERE pet_id = :id", pet_params,
